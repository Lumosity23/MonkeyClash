    ...
    >
      ...
      >
        <g>
          ...
          <path d="M -570 -910 L -540 -910 A 10 10 0 0 1 -540 -890 L -570 -890 A 10 10 0 0 1 -570 -910 Z"></path>
          ...
          {/* MonkeyClash: the "t" of Monkeytype's logo became a "c" */}
          <path
            d="M -465.65 -936.72 A 22 22 0 1 0 -465.65 -907.28"
            fill="none"
            stroke="currentColor"
      ...
      <div class="hidden h-6 place-content-center text-[2rem] leading-0 sm:grid">
        ...
        >
          monkey
          <span
            class={cn("text-main transition-colors duration-250", {
              "text-sub": getFocus(),
            })}
