...
- **Lobby retravaillé** : code du salon en grand en haut à droite (un clic copie le lien d'invitation). La barre de config Monkeytype est en haut à gauche, modifiable par le chef seulement. À droite, de haut en bas : les boutons, le nom du salon et sa visibilité, puis les joueurs en cartes. Le zen est interdit en salon.
